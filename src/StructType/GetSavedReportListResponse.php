...
class GetSavedReportListResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoSavedReportSameParamList = [];
    /**
     ...
     */
    public function __construct(array $midocoSavedReportSameParamList = [])
    {
        $this
     ...
     */
    public function setMidocoSavedReportSameParamList(array $midocoSavedReportSameParamList = []): self
    {

...
class GetUserJwtTokenResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO[]
     */
    ...
    public static function validateMidocoUserJwtTokenForArrayConstraintFromSetMidocoUserJwtToken(?array $values = []): string
    {
        ...
        foreach ($values as $getUserJwtTokenResponseMidocoUserJwtTokenItem) {
            ...
            if (!$getUserJwtTokenResponseMidocoUserJwtTokenItem instanceof \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserJwtToken property can only contain items of type \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO[] $midocoUserJwtToken
     * @return \Pggns\MidocoApi\Mis\StructType\GetUserJwtTokenResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO $item
     * @return \Pggns\MidocoApi\Mis\StructType\GetUserJwtTokenResponse
     */
    public function addToMidocoUserJwtToken(\Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUserJwtToken property can only contain items of type \Pggns\MidocoApi\Mis\StructType\UsersJwtTokenDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
